...
color="#00FFE2"<br>┏━━━━━━━━━━━━━━━┓<br>BN NETWORK<br>┗━━━━━━━━━━━━━━━┛<br></font><br><font 
...
color="#00FF00">▄︻デB̷N̷ N̷E̷T̷W̷O̷R̷K̷̷══━一 </font><br> <font 
color="#00FFE2">क═══════क⊹⊱✫⊰⊹क═══════क</font><br></font><br><font 
color="FFFF00">@bnnetworkYt</font><br>
END
cd
chown -R www-data:www-data /home/vps/public_html
/etc/init.d/nginx restart
...
if [ "$OS" = "Ubuntu" ]; then
    ...
    if [ "$VERSION" = "20.04" ]; then
        echo "Using snap for gotop installation on Ubuntu 20.04"
        snap install gotop
    else
        echo "Different versions of Ubuntu.  You need to install gotop manually."
    fi
else
    echo "Not Ubuntu.  Use apt for gotop installation."
...
echo " "
clear
echo -e "Install was successful and smooth" 
echo -e "" 
echo -e "     <= Must read and do it =>" 
echo -e "VPS login port from 22 changed to 3303" 
echo -e "because if you log in to your VPS using port 22, it's easy to get brute force" 
echo -e "" 
echo -e "To open the AutoSC Input panel" 
echo -e "Type menu" 
echo -e "" 
